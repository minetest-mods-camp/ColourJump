...
```
cd existing_repo
git remote add origin https://gitlab.com/mrfreeman_works/ColourJump.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mrfreeman_works/ColourJump/-/settings/integrations)

...
arena_lib.register_minigame( modname , {
        ...
        properties = {
                ...
                arenaCol_Brown = {x = 1, z = 74, name="wool:brown", id="Brown", isActive=true, hexColor="0x916F46"},
                arenaCol_Pink = {x = 5, z = 74, name="wool:pink", id="Pink", isActive=true, hexColor="0xF8A3FF"},
